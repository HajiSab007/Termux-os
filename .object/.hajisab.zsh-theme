...
PROMPT="
%(?,%{$fg_bold[red]%} ┌─╼%{$fg_bold[red]%}[%{$fg_bold[blue]%}hajisab%{$fg_bold[yellow]%}@%{$fg_bold[cyan]%}termux%{$fg_bold[red]%}]%{$fg_bold[green]%}-%{$fg_bold[red]%}[%{$fg_bold[green]%}%(5~|%-1~/…/%2~|%4~)%{$fg_bold[red]%}]%{$reset_color%} ${git_branch}
